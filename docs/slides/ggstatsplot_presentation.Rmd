...
.font120[
Current count of packages on the Comprehensive R Archive Network (`CRAN`) <font color="red"> > 16,000</font>
]
...
<br>
📊 <font color="blue">information-rich</font> plots with <font color="blue">statistical details</font> <br>
 
📝 plots suitable for scholarly publications and <font color="blue">faster</font> (exploratory) data analysis
]
...
--
 ...
 <br>
 <br>
In a typical *exploratory* data analysis workflow, <font color="blue">data visualization</font> and <font color="blue">statistical modeling</font> are two
...
<font color="blue">Graphical</font> summaries can reveal problems not visible from <font color="blue">numerical</font> statistics.
...
The <font color="blue">grammar of graphics</font> is a powerful framework [(Wilkinson, 2011)](https://www.google.com/books/edition/_/iI1kcgAACAAJ?hl=en&sa=X&ved=2ahUKEwiGl8rJ2KztAhWyElkFHa8NAvkQre8FMBR6BAgMEAc) and can help you make *any* graphics fitting your specific data visualization needs! But...
...
`r emo::ji("pencil")` <font color="blue">Defaults</font> return <br>
...
`speedlm`, `stanfit`, `stanreg`, `summary.lm`, `survreg`, `svyglm`, `svyolr`,
`svyglm`, `tobit`, `truncreg`, `varest`, `vgam`, `vglm`, `wbgee`, `wblm`,
`zeroinfl`, etc.
]
...
.font70[
The default palette 
is <font color="blue">colorblind-friendly</font>.
]
]
...
`ggstatsplot` can be used to get <font color="blue">only plots</font>.
...
`ggstatsplot` can be used to get <font color="blue">only expressions</font>.
...
[`statsExpressions`](https://indrajeetpatil.github.io/statsExpressions/), statistical processing backend for `ggstatsplot`, can provide <font color="blue">only dataframes</font>.
...
.font90[
<font color="blue">Load 'em up!</font>
...
.font90[
<font color="blue">Things to worry about</font> 🤕
...
.content-box-green[
Minimal code needed (`data`, `x`, `y`), which minimizes chances of error and makes for tidy scripts. 💅
]
...
--
`r emo::ji("check")` (defaults too complicated for effectively communicating
...
--
`r emo::ji("check")` (excellent GUI open-source softwares: [JASP](https://jasp-stats.org/) and [jamovi](https://www.jamovi.org/))
...
.pull-left[
<font color="blue">New plots</font>
- density plot
- connected scatterplot
- sankey diagram
- bar plot

<font color="blue">New statistical tests</font>
- survival analysis
- cluster analysis
...
<https://github.com/IndrajeetPatil/ggstatsplot_slides/tree/master/docs/slides>
