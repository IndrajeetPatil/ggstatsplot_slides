...
- Limited types of <font color="blue">plots</font> available. 
...
- <font color="blue">Faceting</font> not implemented (requires writing new `geom_` s).

--

- For the same reason, plots are not `gganimate`-friendly.
