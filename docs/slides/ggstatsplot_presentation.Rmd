...
subtitle: "An Introductory Tutorial (version: 0.6.5)"
author: "Indrajeet Patil"
date: "2020-11-30<br><br>Follow along: **https://tinyurl.com/y376yz6o**"
output:
...
`poissonirr`, `polr`, `ridgelm`, `rjags`, `rlm`, `rlmerMod`, `robmixglm`, `rq`,
`rqss`, `rrvglm`, `scam`, `semLm`, `semLme`, `slm`, `speedglm`, `speedlm`,
`stanfit`, `stanreg`, `survreg`, `svyglm`, `svyolr`, `svyglm`, `tobit`,
`truncreg`, `vgam`, `vglm`, `wbgee`, `wblm`, `zeroinfl`, etc.
]
...
These details are catalogued here:
