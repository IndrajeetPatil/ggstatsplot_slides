...
author: "Indrajeet Patil (Max Planck Institute, Berlin)"
date: "`r Sys.Date()`<br><br><br>**R-Ladies Tunis**"
output:
...
Install the stable version (latest: `0.6.6`) of **ggstatsplot** from 
...
<br>
`r emo::ji("science")` *ggbarstats*: If not
...
# Hypothesis about regression cofficients
