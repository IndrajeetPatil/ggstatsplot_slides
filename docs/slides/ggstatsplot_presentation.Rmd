...
Type | Test
----------- | -------------------------
**<font color="blue">Parametric<font>** | Pearson's correlation coefficient
 **<font color="#ff6600">Non-parametric<font>** | Spearman's rank correlation coefficient
**<font color="#ff00ff">Robust<font>** | Percentage bend correlation coefficient
**<font color="#009933">Bayes Factor<font>** | Pearson's correlation coefficient
...
**opinionated**, yes, but an attempt has been made to make sure that the
defaults follow best principles outlined in the data visualization research.
]
]
