...
Install the stable version (latest: `0.7.2`) of `ggstatsplot` from 
...
`r emo::ji("check")` joint distribution <br>
...
`r emo::ji("check")` inferential statistics ($t$, $z$, $F$, $\chi^2$) <br>
...
<!-- .pull-left[ -->
<!-- .font100[ -->
<!-- The default plots in *.blue[ggstatsplot]* are -->
...
------- | ------------------ | ---- | ----- | ----| ----- 
`ggbetweenstats` | Between group comparisons | **.green[Yes]** | **.green[Yes]** | **.green[Yes]** | **.green[Yes]**
`ggwithinstats` | Within group comparisons | **.green[Yes]** | **.green[Yes]** | **.green[Yes]** | **.green[Yes]**
`gghistostats`, `ggdotplotstats` | Distribution of a numeric variable | **.green[Yes]** | **.green[Yes]** | **.green[Yes]** | **.green[Yes]**
`ggcorrmat` | Correlation matrix | **.green[Yes]** | **.green[Yes]** | **.green[Yes]** | **.green[Yes]**
`ggscatterstats` | Correlation between two variables | **.green[Yes]** | **.green[Yes]** | **.green[Yes]** | **.green[Yes]**
`ggpiestats`, `ggbarstats` | Association between categorical variables | **.green[Yes]** | `NA` | `NA` | **.green[Yes]**
`ggpiestats`, `ggbarstats` | Equal proportions for categorical variable levels | **.green[Yes]** | `NA` | `NA` | **.green[Yes]**
`ggcoefstats` | Regression modeling | **.green[Yes]** | **.green[Yes]** | **.green[Yes]** | **.green[Yes]**
`ggcoefstats` | Random-effects meta-analysis | **.green[Yes]** | `NA` | **.green[Yes]** | **.green[Yes]**
...
<!-- `r emo::ji("check")` `ggbetweenstats` and `ggwithinstats` default to .blue[Welch's *t*-test] and <font -->
<!-- color="blue">Welch's ANOVA] - and not Student's *t*-test and Fisher's -->
