...
significantly lower weight $(t(19.03) = 2.33, p = .031)$. The effect size
$(g_{Hedges} = 0.72, 95\% CI [0.09,1.35])$ for this analysis was found to exceed
Cohen’s (1988) convention for a medium effect $(> .50)$.
]
