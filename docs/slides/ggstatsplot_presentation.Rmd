...
The **grammar of graphics** (implemented in `ggplot2`) tells us that a
statistical graphic is a <font color="blue">*mapping*</font> from  <font
color="blue">*data*</font> to <font color="blue">*aesthetic attributes*</font>
(colour, shape, size) of <font color="blue">*geometric objects*</font> (points,
lines, bars). This means you can make infinite number of graphics, each tailored
for your specific data visualization problem! As such, this is an incredibly
powerful framework to prepare graphics. But...
...
- <font color="pink">distribution summary</font>
]
]
...
```
.font80[
Technically, you only need two
columns in the dataframe-
<font color="blue">term</font> and <font color="blue">column</font>.
]
...
.font80[
Contributions (big or small) welcome! `r emo::ji("heart")`
]
...
- Read and correct any inconsistencies in the [documentation](https://indrajeetpatil.github.io/ggstatsplot/)
