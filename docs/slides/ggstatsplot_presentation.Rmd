...
📝 suitable for <font color="blue">faster</font> (exploratory) data analysis and scholarly publications
]
...
Install the stable version (latest: `0.7.1`) of `ggstatsplot` from 
...
`r emo::ji("check")` inferential statistics <br>
`r emo::ji("check")` model fit indices (AIC + BIC)
]
...
--
`r emo::ji("check")` not necessary; can also be useful *only* during exploratory phase
