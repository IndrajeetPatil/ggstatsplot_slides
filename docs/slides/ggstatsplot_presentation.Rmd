...
date: "2019-03-28<br><br>Follow along: **https://tinyurl.com/y376yz6o**"
output:
...
----------- | -- | --------------------------
**<font color="blue">Parametric<font>** | > 2 | Student's or Welch's one-way ANOVA
...
**<font color="#ff6600">Non-parametric<font>** | > 2 | $\eta_{H}^2$ (*H*-statistic based eta-squared) | <font color="green">Yes<font>
**<font color="#ff6600">Non-parametric<font>**  | 2 | *r* (computed as $Z/\sqrt{N}$) | <font color="green">Yes<font>
...
**<font color="#ff6600">Non-parametric<font>** | > 2 | Friedman test
**<font color="#ff6600">Non-parametric<font>** | 2 | Mann–Whitney *U* test
...
.right-plot[
```{r ggscatterstats_3, ref.label = 'ggscatterstats_3', echo = FALSE}
```
]
...
- `"bf"` → <font color="red">not yet implemented</font>
...
**<font color="#ff6600">Non-parametric<font>** | *r* (computed as $Z/\sqrt{N}$) | <font color="green">Yes<font>
**<font color="#ff00ff">Robust<font>** | $M_{robust}$ (Robust location measure) | <font color="green">Yes<font>
**<font color="#009933">Bayes Factor<font>** | <font color="red">No<font> | <font color="red">No<font>
...
Goodness of fit | <font color="red">No<font> | <font color="red">No<font> 
...
.pull-left[
Me: **<font color="blue">Parametric<font>**
```{r type_p, eval = FALSE}
library(ggstatsplot)
...
.pull-right[
Reviewer-2: **<font color="#ff6600">Non-parametric<font>** 
