...
`{ggstatsplot}` provides- <br> <br>
📊 information-rich plots with statistical details <br> <br> 
...
Hypothesis about group differences: independent measures design
