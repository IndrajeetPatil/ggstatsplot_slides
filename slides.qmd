...
You can get the development version of the package from [Github](https://github.com/IndrajeetPatil/ggstatsplot):
...
## ggbetweenstats - For between-group comparisons {.smaller} 
...
✅   pairwise comparisons <br> ✅   Bayesian hypothesis-testing <br> ✅   Bayesian estimation
:::
...
## ggwithinstats - repeated measures equivalent {.smaller}
